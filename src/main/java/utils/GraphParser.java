...
public class GraphParser {
   ...
   private static void addNodes_EdgesToGraph(String line, Graph graph, boolean directed){
    ...
    public static void main(String[] args) throws IOException, URISyntaxException {
        String path1 = ResourceLoader.getResourcePath("graph02.gka").toString();
        Graph graph = parseFromFile(path1);
        saveGraphToFile("PROBE", graph, false);
    }
    ...
    private static String extractNameFromFile(String file){
       Pattern pattern = Pattern.compile("([^/\\\\]+)\\.gka$");
       String fileName = "";
